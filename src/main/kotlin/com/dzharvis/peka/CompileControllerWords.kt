...
data class Instructions(val steps: List<InstructionStep>)

fun compileInstruction(instrCode: Int, step: List<Int>, flagsIn: List<List<Int>>, words: List<Int>): Instructions {
...
fun compile(): List<Instructions> {
    ...
    val LDI = compileInstruction(5, defaultSteps, anyFlags, listOf(InstRegO or ARegI, 0, 0))
